...
$idc=$_SESSION["idc"];
$stid = oci_parse($conn, "SELECT poste, entreprise, adresse, date_candidature, competences_exigees    FROM candidature WHERE idc='$idc'");
oci_execute($stid);

 // ajouter l'action dans la table historique 
$texte="INSERT INTO historique (idc, action, date_action) VALUES ('$idc', 'afficher mes candidature', SYSDATE)";
//echo $texte;
